...
public class PostController {
    ...
    @Operation(
            ...
            description = "Update Post REST API is used to update a single post in the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Http Status 200 SUCCESS"
    ...
    @Operation(
            ...
            description = "Delete Post REST API is used to delete a single post in the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Http Status 200 SUCCESS"
